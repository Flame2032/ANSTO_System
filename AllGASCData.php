...
<html lang="en">
    ...
    <body>
        ...
        <div class = 'filterBar' id = "filterBar">
            <form action = "AllGASCData.php" method = 'POST'>
                ...
                <div class = 'container-white'>
					<input type="checkbox" name="filter[]" value ="`gasCID`"/>gasCID<br>
                    ...
                    <input type = 'checkbox' name="filter[]" value ="`Date1`"/>Date<br>
                    <input type = 'checkbox' name="filter[]" value ="`Time1`"/>Time<br>
                    <input type = 'checkbox' name="filter[]" value ="`Initials1`"/>Initials<br>
					<input type = 'checkbox' name="filter[]" value ="`Vacuum Valve Closed`"/>Vacuum Valve Closed<br>
					<input type = 'checkbox' name="filter[]" value ="`Pre Vacuum`"/>Pre Vacuum<br>
					<input type = 'checkbox' name="filter[]" value ="`Pre Mass Volume`"/>Pre Mass Volume<br>
                    ...
                    <input type = 'checkbox' name="filter[]" value ="`Date2`"/>Date<br>
                    <input type = 'checkbox' name="filter[]" value ="`Time2`"/>Time<br>
                    <input type = 'checkbox' name="filter[]" value ="`Initials2`"/>Initials<br>
					...
					<input type = 'checkbox' name="filter[]" value ="`Finish Flow Rate`"/>Finish Flow Rate<br>
...
//code for Filter ID tab
    ...
    // Code For Filter Exposure tab  
	 ...
	 // check from and to dates
      $sql = "SELECT * FROM gasc WHERE ExposureDate >= '$ExposureDateFromBox' AND ExposureDate <= '$ExposureDateToBox'  ";
      $result = mysqli_query($connection,$sql) or die(mysql_error());
      if (mysqli_num_rows($result) == 0)
      {
      echo "Sorry, but we can not find an entry to match your query...<br><br>";
      ...
      $sql = "SELECT * FROM gasc WHERE ExposureDate >= '$ExposureDateFromBox'  ";
