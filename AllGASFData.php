   ...
   <body>
      ...
      <div class = "secondBarContainer">
         <div class = "secondBar">
            ...
            <button type = "button" onclick = "ViewGASFData();" class = "btn-filter-menu" style = "background-color: #162bb3;">
               <p style = "width:50px; color: #04dcf0;">GAS-F</p>
            </button>
            <div class = "rightDiv">
      ...
      <?php
         ...
         while ($row = mysqli_fetch_array($result)) {
            ...
            {
         $result = mysqli_query($connection,"SELECT * FROM gasf WHERE `Exposure Date` >= now()-interval 3 month");
         $all_property = array();  //declare an array for saving property
         //showing property
         echo '<table class="data-table" border="2" width="auto" overflow: "auto" ID="Table1" style="font-size: 70%;">
                <tr class="data-heading">';  //initialize table tag
