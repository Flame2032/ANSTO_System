    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function DisplayLogsheet (id) {
                window.location.href = "SingleASPLogsheet.php?id="+id;
            }
    ...
    <body>
        ...
        <div class = "secondBarContainer">
            <div class = "secondBar">
                ...
                <button type = "button" onclick = "" class = "btn-filter-menu">
                    <p class = 'whiteText' style = "width:50px;">GAS</p>
                </button>
                <div class = "rightDiv">
        ...
        <div class = "content">
            <p class = "headingText">List of all ASP logsheets:</p>
            <?php 
